  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <div ref={containerRef} className="flex h-screen flex-1">
        ...
        {/* 2. 拖拽分隔条（关键新增） */}
        <div
          className={`w-1 ${isResizing ? "bg-blue-500 cursor-col-resize" : "bg-gray-200 hover:bg-gray-300 cursor-col-resize"}`}
          style={{ 
            height: "100%", // 占满高度
            userSelect: "none", // 避免拖拽时选中分隔条
            transition: "background-color 0.2s ease"
          }}
          onMouseDown={handleResizeStart} // 仅在分隔条上按下才触发拖拽
        />
