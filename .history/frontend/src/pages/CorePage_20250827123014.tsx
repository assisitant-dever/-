...
import { saveAs } from "file-saver"; // ✅ 记得加上这个
...
export default function CorePage() {
  ...
  const [mainWidth, setMainWidth] = useState(50); // 中间部分宽度 %
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const aiMsg = { role: "assistant", content: text, docx_file: filename, id: Date.now() };
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex h-screen flex-1">
        ...
        <div
          ...
          style={{ flexBasis: `${mainWidth}%`, transition: "flex-basis 0.1s linear" }}
        >
          {/* 聊天区域 */}
        ...
        {/* 右侧：预览 */}
        <div
          className="bg-gray-50 flex flex-col border-l"
          style={{ flexBasis: `${100 - mainWidth}%`, transition: "flex-basis 0.1s linear" }}
        >
          {/* 预览区域 */}
          <div className="flex-1 p-4 overflow-y-auto">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: previewHTML || marked.parse(previewContent || "暂无内容"),
              }}
            />
          </div>
