      ...
      >
        ...
        {isOpen && (
          <button
            ...
            className="absolute top-4 right-4 z-50 w-8 h-8 flex items-center justify-center bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-full"
            title="收回侧边栏"
          >
            收回
          </button>
