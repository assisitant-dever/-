      ...
      >
        {isOpen && (
          <button
            ...
            className="absolute top-2 right-4 z-50 w-6 h-6 flex items-center justify-center bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-md"
            title="收回侧边栏"
