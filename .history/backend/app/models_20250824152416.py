from sqlalchemy import Column, Integer, String, TIMESTAMP, ForeignKey, Index, Boolean,Enum  
from sqlalchemy.orm import relationship, declarative_base
from datetime import datetime
import pytz  # 推荐使用 pytz 处理 UTC
from pydantic import BaseModel,from_attributes
...
class AIModel(Base):
    ...
    training_data = Column(String(500))  
