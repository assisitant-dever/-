...
class DocumentHistory(Base):
    ...
    template_id = Column(Integer, ForeignKey("templates.id"), nullable=True)  # 新增
    created_at = Column(DateTime, default=datetime.utcnow)
    user = relationship("User", back_populates="documents")
    template = relationship("Template", back_populates="documents")  # 新增
...
class Template(Base):
    ...
    documents = relationship("DocumentHistory", back_populates="template")  # 新增
