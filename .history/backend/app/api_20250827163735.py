...
# ----------------- 核心接口：公文生成（适配多平台Client+数据库会话） -----------------@router.post("/generate")
async def generate_document(
    ...
    try:
        if ai_model_id:
            ...
            user_config = generate_text_for_user.get_user_model_preference(  # 假设该函数可直接调用
    ...
    async def sse_generator():
        ...
        try:
            ...
            metadata = {
                ...
                "full_text": generated_full  # 可选：返回完整文本，便于前端备份
            }
